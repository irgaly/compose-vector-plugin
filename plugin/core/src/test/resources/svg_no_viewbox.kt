...
public val svg_no_viewbox: ImageVector
    get() {
        if (_svg_no_viewbox != null) {
            return _svg_no_viewbox!!
        }
...
private var _svg_no_viewbox: ImageVector? = null

@Preview
@Composable
private fun svg_no_viewboxPreview() {
    Image(svg_no_viewbox, null)
}

@Preview(showBackground = true)
@Composable
private fun svg_no_viewboxBackgroundPreview() {
    Image(svg_no_viewbox, null)
}
